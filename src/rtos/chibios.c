...
static struct symbol_table_elem chibios_symbol_list[] = {
	{ "rlist", 0, true, false},		/* Thread ready list */
	{ "ch", 0, true, false},		/* System data structure */
	{ "ch_debug", 0, false, false},	/* Memory Signature containing offsets of fields in rlist */
	{ NULL, 0, false, false}
};
