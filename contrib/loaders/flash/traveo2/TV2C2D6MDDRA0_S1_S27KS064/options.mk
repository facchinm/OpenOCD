GLOBAL_DEFS += -DCY_USE_PSVP=0 -Dtviic2d6mddr=1 -DCYT4ENDBQS=1 -DCY_MCU_rev_a=1 -DCY_500BGA_EVK_rev_a=1 -DUSED_SMIF_CHANNEL=1 -DROW_SIZE=512
...
INCLPATHS :=											\
	...
	-Isdl/tviic2d6mddr/src/examples/smif				\
	...
	-Isdl/tviic2d6mddr/src/examples/smif/S27K			\
